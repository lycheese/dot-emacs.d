...
(cond ((string-equal system-name "pop-os")
       (setq doom-font (font-spec :family "TerminessTTF Nerd Font Mono" :size 12.0)))
      ((string-equal system-name "nanorocket")
       (setq doom-font (font-spec :family "TerminessTTF Nerd Font Mono" :size 14.0))))
#+end_src
* Theme
#+begin_src elisp
